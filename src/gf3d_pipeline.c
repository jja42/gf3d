...
void gf3d_pipeline_create_basic_ui_descriptor_pool(Pipeline *pipe)
{
    int i;
...
void gf3d_pipeline_create_descriptor_sets(Pipeline *pipe)
{
    ...
    slog("descriptorCursor %d",pipe->descriptorCursor[0]);
...
void gf3d_pipeline_create_basic_ui_descriptor_set_layout(Pipeline *pipe)
{
    VkDescriptorSetLayoutCreateInfo layoutInfo = {0};
    VkDescriptorSetLayoutBinding samplerLayoutBinding = {0};
    ...
    memcpy(&bindings[0],&samplerLayoutBinding,sizeof(VkDescriptorSetLayoutBinding));
